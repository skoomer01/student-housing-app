...
namespace Student_housing
{
    public class NormalExpense
    {
        ...
        public double AmountToBePaidPerMember
        {
            get
            {
                return this.amountToBePaidPerMember;
            }
        }

        public double AmountLeftToBePaid
        {
            get
            {
        ...
        public List<User> MembersWhoPaid
        {
            get
            {
                return this.membersWhoPaid;
            }
        }
